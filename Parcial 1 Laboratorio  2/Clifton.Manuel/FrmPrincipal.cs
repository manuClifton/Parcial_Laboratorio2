...
namespace Clifton.Manuel
{
    public partial class FrmPrincipal : Form
    {
        ...
        //    //using (XmlTextWriter Escribir = new XmlTextWriter(Direccion + "\\Docentes.xml", Encoding.UTF8))
        //    //{
        ...
        //    //using (XmlTextWriter Escribir = new XmlTextWriter(Direccion + "\\NoDocentes.xml", Encoding.UTF8))
        //    //{
        ...
        //    //using (XmlTextWriter Escribir = new XmlTextWriter(Direccion + "\\Responsables.xml", Encoding.UTF8))
        //    //{
        ...
        //    //using (XmlTextWriter Escribir = new XmlTextWriter(Direccion + "\\AlumnosSinAula.xml", Encoding.UTF8))
        //    //{
        ...
        //    ////aulas.Add(new Aula(EColor.Amarillo, docentes[5], ETurno.Tarde));


        //    //using (XmlTextWriter Escribir = new XmlTextWriter(Direccion + "\\AlumnosConAula.xml", Encoding.UTF8))
        //    //{
        //    //    XmlSerializer ser = new XmlSerializer((typeof(List<Alumno>)));
        //    //}

        //    //using (XmlTextWriter Escribir = new XmlTextWriter(Direccion + "\\Aulas.xml", Encoding.UTF8))
        //    //{
        ...
        private void FrmPrincipal_Load(object sender, EventArgs e)
        {
            ...
            using (XmlTextReader Leer = new XmlTextReader(Direccion + "\\AlumnosSinAula.xml"))
            {
                XmlSerializer ser = new XmlSerializer(typeof(List<Alumno>));
            ...
            using (XmlTextReader Leer = new XmlTextReader(Direccion + "\\AlumnosConAula.xml"))
            {
                XmlSerializer ser = new XmlSerializer(typeof(List<Alumno>));
            ...
            using (XmlTextReader Leer = new XmlTextReader(Direccion + "\\Responsables.xml"))
            {
                XmlSerializer ser = new XmlSerializer(typeof(List<Responsable>));
            ...
            using (XmlTextReader Leer = new XmlTextReader(Direccion + "\\Docentes.xml"))
            {
                XmlSerializer ser = new XmlSerializer(typeof(List<Docente>));
            ...
            using (XmlTextReader Leer = new XmlTextReader(Direccion + "\\NoDocentes.xml"))
            {
                XmlSerializer ser = new XmlSerializer(typeof(List<Administrativo>));
            ...
            using (XmlTextReader Leer = new XmlTextReader(Direccion + "\\Aulas.xml"))
            {
                XmlSerializer ser = new XmlSerializer(typeof(List<Aula>));
